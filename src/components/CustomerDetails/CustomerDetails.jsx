...
import { FolderOpen, ScanLine, Archive, ArchiveRestore, MessageCircle, Paperclip, Folder, File, Image, FileText, FileSpreadsheet, X, Loader, Copy, Check, ClipboardCheck, FolderInput } from 'lucide-react';
