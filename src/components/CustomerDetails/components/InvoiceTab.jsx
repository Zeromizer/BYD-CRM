...
function InvoiceTab({
  ...
  // Others: Add Others from VSA Pricing & Deposit
      ...
      <div className="info-section">
        ...
        <div className="invoice-pricing-grid">
          ...
          <div className="pricing-row">
            ...
            <PriceTooltip
              field="others"
              tooltip={othersData.tooltip}
              source={othersData.source}
            >
              <div className="price-input">
                <span>$</span>
                <span className="price-value-text">{formatNum(othersData.value)}</span>
              </div>
            </PriceTooltip>
          </div>
          <div className="pricing-row">
